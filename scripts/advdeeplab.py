...
from utils import Trainer_Deeplab, Evaluator_DeepLab, eval_wrapper, ModelUtils, AdvTrain_Deeplab
...
trainer = AdvTrain_Deeplab(model, disc, optim, disc_optim, criterion, metric)
